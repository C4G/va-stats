...
./pages/api/getbatchesdata.ts
./pages/api/updatebatches.ts
./pages/batch/[id].tsx:
*/
/*
...
export default function Page() {
  ...
  const handleNewBatchReset = () => {
    var resetsubmitfeedback = getElementById("newbatchresetfeedback");
  ...
  const handleNewBatchSubmit = async () => {
    const form = getElementById("batch-create-form");
    // form.submit();
