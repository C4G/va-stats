                  ...
                  <div className={styles.addstaffform}>
                    ...
                    <form onSubmit={handleSubmit} className={styles.addstaffforminputs} autoComplete="off">
                      <section className={styles.addstaffformsec1}>
                        ...
                        <input required id="employeeId" name="employeeId" className={styles.addstaffforminputsbox} />
                        <br />
                        <br />
                        ...
                        <select required className={styles.addstaffforminputsbox} id="visualacuity" name="visualacuity">
                        ...
                        <input required className={styles.addstaffforminputsbox} id="workbase" name="workbase" />
                        <br />
                        <br />
                      ...
                      <section className={styles.addstaffformsec2}>
                        ...
                        <select required className={styles.addstaffforminputsbox} id="natureofjob" name="natureofjob">
                          <option value="Part-time">Part-time</option>
                          <option value="Full-time">Full-time</option>
                        </select>
                        &nbsp;
                        <br />
                        <label htmlFor="has_contract" className={styles.addstafflabel} style={{ paddingRight: "1rem" }}>
                          Has Contract?
                        </label>
                        <input
                          type="checkbox"
                        ...
                        <input required type="email" id="email" name="email" className={styles.addstaffforminputsbox} />
                        <br />
                        <br />
                        <label
                      ...
                      <section className={styles.addstaffformsec3}>
                        ...
                        <select required className={styles.addstaffforminputsbox} id="role" name="role">
                        ...
                        <select required className={styles.addstaffforminputsbox} id="active" name="isactive">
                          &nbsp;*
